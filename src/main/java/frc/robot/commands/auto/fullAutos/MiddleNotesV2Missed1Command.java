...
public class MiddleNotesV2Missed1Command extends SequentialCommandGroup {
  /** Creates a new MiddleNotesMissed1Command. */
  public MiddleNotesV2Missed1Command(DriveSubsystem drive, ShooterSubsystem shooter, IntakeSubsystem intake, LimelightSubsystem shooterLimelight, LimelightSubsystem intakeLimelight) {
    PiratePath path = new PiratePath("MiddleNotePathV2Missed1", false);
