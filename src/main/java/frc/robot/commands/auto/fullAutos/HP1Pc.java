...
public class HP1Pc extends SequentialCommandGroup {
  /** Creates a new HP1Pc. */
  public HP1Pc(DriveSubsystem drive, ShooterSubsystem shooter, IntakeSubsystem intake, LimelightSubsystem limelight) {
