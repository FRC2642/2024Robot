...
public class AmpSide3Pc extends SequentialCommandGroup {
  /** Creates a new AmpSide3Pc. */
  public AmpSide3Pc(DriveSubsystem drive, ShooterSubsystem shooter, IntakeSubsystem intake, LimelightSubsystem shooterLimelight, LimelightSubsystem intakeLimelight) {
    PiratePath path = new PiratePath("AmpSide3Piece", false);
    ...
    addCommands(
      ...
      //Drive to 1st Shot
      new FollowPathCommand(drive, shootNote1, true, 0.25),
      ...
      //Get 2nd note
      new DivertToGamePieceCommand(drive, intakeLimelight, DetectionType.NOTE, getNote2, false, 0, 0.3, 1.8, true).alongWith(
