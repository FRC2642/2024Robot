...
public class AmpSide3PcMissed1 extends SequentialCommandGroup {
  /** Creates a new AmpSide3PcMissed1. */
  public AmpSide3PcMissed1(DriveSubsystem drive, ShooterSubsystem shooter, IntakeSubsystem intake, LimelightSubsystem shooterLimelight, LimelightSubsystem intakeLimelight) {
    PiratePath path = new PiratePath("AmpSide3PcMissed1", false);
