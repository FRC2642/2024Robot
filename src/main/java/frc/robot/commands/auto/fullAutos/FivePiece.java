...
public class FivePiece extends SequentialCommandGroup {
  ...
  public FivePiece(DriveSubsystem drive, ShooterSubsystem shooter, IntakeSubsystem intake, LimelightSubsystem shooterLimelight, LimelightSubsystem intakeLimelight) {
    ...
    addCommands(
      ...
      //Get 2nd note
      new DivertToGamePieceCommand(drive, intakeLimelight, DetectionType.NOTE, note2, true, 0.25, 0.3, 0.8, true).alongWith(
      ...
      //Get 3rd note
      new DivertToGamePieceCommand(drive, intakeLimelight, DetectionType.NOTE, note3, false, 0.25, 0.3, 0.6, true).alongWith(
          new IntakeUntilFound(()->IntakePosition.EXTENDED, intake, shooter, true)
      ).withTimeout(3),
      ...
      //Get 4th note
      new DivertToGamePieceCommand(drive, intakeLimelight, DetectionType.NOTE, note4, false, 0.25, 0.3, 1, true).alongWith(
          new IntakeUntilFound(()->IntakePosition.EXTENDED, intake, shooter, true)
      ).withTimeout(3),
      ...
      new FollowPathCommand(drive, shootNote5, false, 0.25)/*.alongWith(new SetIntakeCommand(intake, ()->IntakePosition.RETRACTED))*/,
