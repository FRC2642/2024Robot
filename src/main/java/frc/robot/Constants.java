...
public final class Constants {
    ...
    // Ratios
    public static final double FEET_PER_DISPLACEMENT = 0.17458101;
    ...
    public static final int JET_PWM_CHANNEL = 0;
    ...
    public static final double SHOOTER_TILT_ENCODER_OFFSET = -363.5;
